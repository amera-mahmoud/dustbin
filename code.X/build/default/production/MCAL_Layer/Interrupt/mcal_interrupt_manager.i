...
# 1 "MCAL_Layer/Interrupt/../GPIO/../std_liberaries.h" 1
# 11 "MCAL_Layer/Interrupt/../GPIO/../std_liberaries.h"
...
# 11 "MCAL_Layer/Interrupt/../GPIO/../std_liberaries.h" 2
...
# 13 "MCAL_Layer/Interrupt/../GPIO/../std_liberaries.h" 2
...
# 71 "MCAL_Layer/Interrupt/../GPIO/hal_gpio.h"
...
void __attribute__((picinterrupt(("")))) InterruptManager(void)
{
    ...
    if((0X01 == PIE1bits.CCP1IE) && (0X01 == PIR1bits.CCP1IF))
    {
        CCP1_ISR();
    }
    else
    ...
    if((0X01 == PIE2bits.CCP2IE) && (0X01 == PIR2bits.CCP2IF))
    {
        CCP2_ISR();
    }
    else
