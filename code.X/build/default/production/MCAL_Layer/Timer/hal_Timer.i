# 1 "MCAL_Layer/Timer/hal_Timer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/Timer/hal_Timer.c" 2
# 1 "MCAL_Layer/Timer/hal_Timer1.h" 1
# 12 "MCAL_Layer/Timer/hal_Timer1.h"
# 1 "MCAL_Layer/Timer/../../MCAL_Layer/GPIO/hal_gpio.h" 1
# 12 "MCAL_Layer/Timer/../../MCAL_Layer/GPIO/hal_gpio.h"
# 1 "MCAL_Layer/Timer/../../MCAL_Layer/GPIO/../mcal_std_types.h" 1
# 12 "MCAL_Layer/Timer/../../MCAL_Layer/GPIO/../mcal_std_types.h"
# 1 "MCAL_Layer/Timer/../../MCAL_Layer/GPIO/../compiler.h" 1
# 11 "MCAL_Layer/Timer/../../MCAL_Layer/GPIO/../compiler.h"
...
# 11 "MCAL_Layer/Timer/../../MCAL_Layer/GPIO/../compiler.h" 2
# 12 "MCAL_Layer/Timer/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2

# 1 "MCAL_Layer/Timer/../../MCAL_Layer/GPIO/../std_liberaries.h" 1
# 11 "MCAL_Layer/Timer/../../MCAL_Layer/GPIO/../std_liberaries.h"
...
# 11 "MCAL_Layer/Timer/../../MCAL_Layer/GPIO/../std_liberaries.h" 2
...
# 13 "MCAL_Layer/Timer/../../MCAL_Layer/GPIO/../std_liberaries.h" 2
# 13 "MCAL_Layer/Timer/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2


# 1 "MCAL_Layer/Timer/../../MCAL_Layer/GPIO/../device_config.h" 1
# 15 "MCAL_Layer/Timer/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2
...
# 12 "MCAL_Layer/Timer/../../MCAL_Layer/GPIO/hal_gpio.h" 2
...
# 71 "MCAL_Layer/Timer/../../MCAL_Layer/GPIO/hal_gpio.h"
...
# 13 "MCAL_Layer/Timer/../Interrupt/mcal_interrupt_config.h"
# 1 "MCAL_Layer/Timer/../Interrupt/mcal_interrupt_cfg.h" 1
# 13 "MCAL_Layer/Timer/../Interrupt/mcal_interrupt_config.h" 2
# 12 "MCAL_Layer/Timer/../Interrupt/mcal_internal_interrupt.h" 2
# 42 "MCAL_Layer/Timer/../Interrupt/mcal_internal_interrupt.h"
void all_interrupt_enable();
void all_interrupt_disable();
# 13 "MCAL_Layer/Timer/hal_Timer1.h" 2
...
# 62 "MCAL_Layer/Timer/hal_Timer1.h"
...
std_ReturnType timer1_inti(timer1_config_t* tmr1_obj)
{
    ...
    else
    {
        ...
        if(0x00 == tmr1_obj->timer_mode)
            (T1CONbits.TMR1CS = 0);
        else if(0x01 == tmr1_obj->timer_mode)
        {
            (T1CONbits.TMR1CS = 1);

            if (0x01 == tmr1_obj->timer1_oscilator)
                (T1CONbits.T1OSCEN = 1);
            else if (0x00 == tmr1_obj->timer1_oscilator)
                (T1CONbits.T1OSCEN = 0);
            else
                ret = (std_ReturnType)0X00;;

            if (0x01 == tmr1_obj->extclk_sync)
                (T1CONbits.T1SYNC = 0);
            else if (0x00 == tmr1_obj->extclk_sync)
                (T1CONbits.T1SYNC = 1);
            else
                ret = (std_ReturnType)0X00;;
        }
        ...
        (T1CONbits.T1CKPS = tmr1_obj->prescaler_select);
...
std_ReturnType timer1_register_read(timer1_config_t* tmr1_obj, uint16* value)
{
    std_ReturnType ret = (std_ReturnType)0X00;;
    uint8 tmr1l = 0, tmr1h;
    if((((void*)0) == tmr1_obj)||(((void*)0) == value))
    {
        ret = (std_ReturnType)0X00;;
    }
    else
