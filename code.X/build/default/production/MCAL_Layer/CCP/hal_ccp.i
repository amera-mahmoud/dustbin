...
# 12 "MCAL_Layer/CCP/../GPIO/../mcal_std_types.h"
# 1 "MCAL_Layer/CCP/../GPIO/../compiler.h" 1
# 11 "MCAL_Layer/CCP/../GPIO/../compiler.h"
...
# 11 "MCAL_Layer/CCP/../GPIO/../compiler.h" 2
# 12 "MCAL_Layer/CCP/../GPIO/../mcal_std_types.h" 2

# 1 "MCAL_Layer/CCP/../GPIO/../std_liberaries.h" 1
# 11 "MCAL_Layer/CCP/../GPIO/../std_liberaries.h"
...
# 11 "MCAL_Layer/CCP/../GPIO/../std_liberaries.h" 2
...
# 13 "MCAL_Layer/CCP/../GPIO/../std_liberaries.h" 2
# 13 "MCAL_Layer/CCP/../GPIO/../mcal_std_types.h" 2


# 1 "MCAL_Layer/CCP/../GPIO/../device_config.h" 1
# 15 "MCAL_Layer/CCP/../GPIO/../mcal_std_types.h" 2
...
# 71 "MCAL_Layer/CCP/../GPIO/hal_gpio.h"
...
void (*ccp1_InterruptHandler)(void) = ((void*)0);
...
std_ReturnType ccp1_init(const ccp1_config_t* ccp1_obj)
{
    ...
    else
    {
       ...
       (CCP1CONbits.CCP1M = ccp1_obj->mode);
       if((4 == ccp1_obj->mode)
               || (5 == ccp1_obj->mode))
       {
           TRISCbits.TRISC2 = 1;
...
void (*ccp2_InterruptHandler)(void) = ((void*)0);
...
std_ReturnType ccp2_init(const ccp2_config_t* ccp2_obj)
{
    ...
    else
    {
       ...
       (CCP2CONbits.CCP2M = ccp2_obj->mode);
       if((4 == ccp2_obj->mode)
               || (5 == ccp2_obj->mode))
       {
           TRISCbits.TRISC1 = 1;
